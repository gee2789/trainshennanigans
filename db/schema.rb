...
ActiveRecord::Schema.define(version: 20170613145239) do
  ...
  create_table "situations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["line_direction_id"], name: "index_situations_on_line_direction_id"
  end
